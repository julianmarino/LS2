...
import ai.synthesis.grammar.dslTree.builderDSLTree.NeighbourTypeEnum;
...
public class BuilderGrammars {
    ...
    //********************************************************
    private static BuilderGrammars uniqueInstance;
     ...
     */
    public static synchronized BuilderGrammars getInstance() {
        if (uniqueInstance == null) {
            uniqueInstance = new BuilderGrammars();
        }
...
//                    discreteValue = p.getDiscreteSpecificValues().get(idChosen);
    ...
    public iDSL composeNeighbour(iDSL dsl) {
        ...
        int nNode = rand.nextInt(BuilderGrammars.getNumberofNodes((iNodeDSLTree) dsl)) + 1;
        //System.out.println("Node selected " + nNode);
        iNodeDSLTree targetNode = BuilderGrammars.getNodeByNumber(nNode, (iNodeDSLTree) dsl);
    ...
    public static iDSL getNeighbourAgressively(iDSL dsl) {
        return BuilderGrammars.getInstance().composeNeighbour(dsl);
    }
...
//       }
    ...
    public static iDSL changeNeighbourPassively(iDSL dsl) {
        BuilderGrammars builder = BuilderGrammars.getInstance();
